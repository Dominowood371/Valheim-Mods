Mod Valweed Russian Translation Version 0.2.7 - 0.3.3.
...
Скачайте файл `Valweed_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\Valweed\Assets\Translations\Russian`.
