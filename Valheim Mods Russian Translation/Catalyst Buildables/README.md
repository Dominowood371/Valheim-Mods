Mod Catalyst Buildables Russian Translation Version 0.0.2.
...
Скачайте файл `CatalystBuildables_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\CatalystBuildables\Assets\Translations\Russian`.
