Mod Better Wards Russian Translation Version 1.6.0.
...
Скачайте файл `azumatt.BetterWards.Localization.cfg` и с заменой переместите файл в папку `Valheim\BepInEx\config`
