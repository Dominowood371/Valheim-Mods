...
### Установка BoneAppetit Rus.rar

Скачайте архив `BoneAppetit-3.0.2-Rus.rar` и распакуйте архив, в архиве будет папка `BoneAppetit` переместите эту папку со всем содержимым в папку с игрой `Valheim\BepInEx\plugins`.
...
### Скачивание BoneAppetit Rus.rar
1. Найдите архив `BoneAppetit-3.0.2-Rus.rar`, который вы хотите загрузить.
2. Нажмите на его, чтобы просмотреть содержимое файла в GitHub.
...
[![Скачать](https://img.shields.io/badge/Скачать-3.0.2-blue?style=for-the-badge)]()
