Mod Chest Reloaded Russian Translation Version 0.7.1.
...
Скачайте файл `ChestReloaded_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\ChestReloaded\Assets\Translations\Russian`.
