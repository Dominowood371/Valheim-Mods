Mod Odin Plus Russian Translation Version 1.0.0.

### Описание

Перевод мода [OdinPlusRemakeJVL](https://github.com/Digitalroot-Valheim/OdinPlusRemakeJVL) на русский язык для игры Valheim. 

### Установка

Скачайте файл `OdinPlus_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\OdinPlusRemakeJVL\Assets\Translations\Russian`.
