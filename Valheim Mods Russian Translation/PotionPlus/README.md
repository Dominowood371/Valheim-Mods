Mod PotionPlus Russian Translation Version 1.1.0 - 2.0.5.

### Описание

Перевод мода [PotionPlus](https://valheim.thunderstore.io/package/OdinPlus/PotionPlus/) на русский язык для игры Valheim. 

### Установка

Скачайте файл `PotionPlus_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\PotionPlus\Assets\Translations\Russian`.
