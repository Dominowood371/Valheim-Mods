Mod Atos Arrows JVL Russian Translation Version 0.7.6 - 1.0.0.
...
Скачайте файл `AtosArrowsJVL.russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\AtosArrowsJVL\Assets\Translations\Russian`.
