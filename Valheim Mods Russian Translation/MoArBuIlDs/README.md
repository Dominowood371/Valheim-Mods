Mod MoArBuIlDs Russian Translation Version 1.1.4.
...
Скачайте файл `MoArBuIlDs_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\MoArBuIlDs\Assets\Translations\Russian`.
