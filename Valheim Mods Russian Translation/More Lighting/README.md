Mod More Lighting Russian Translation Version 1.0.3.
...
Скачайте файл `Morelighting_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\Morelighting\Assets\Translations\Russian`.
