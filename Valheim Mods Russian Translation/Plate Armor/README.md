...
Скачайте файл `PlateArmor-Version-2.0.0_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\PlateArmor\Assets\Translations\Russian`.
