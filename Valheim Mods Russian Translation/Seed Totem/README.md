Mod Seed Totem Russian Translation Version 1.1.5 - 4.1.0.
...
Скачайте файл `SeedTotem_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\SeedTotem\Assets\Translations\Russian`.
