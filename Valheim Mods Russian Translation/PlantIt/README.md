Mod PlantIt Russian Translation Version 0.1.2 - 0.1.5.
...
Скачайте файл `PlantIt_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\PlantIt\Assets\Translations\Russian`.
