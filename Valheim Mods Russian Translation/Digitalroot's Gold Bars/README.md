Mod Digitalroot's Gold Bars Russian Translation Version 1.1.2 - 1.2.0.

### Описание

Перевод мода [Digitalroot's Gold Bars](https://www.nexusmods.com/valheim/mods/1448) на русский язык для игры Valheim. 

### Установка

Скачайте файл `Digitalroot.Valheim.GoldBars_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\Digitalroot.Valheim.GoldBars_russian.json\Assets\Translations\Russian`.
