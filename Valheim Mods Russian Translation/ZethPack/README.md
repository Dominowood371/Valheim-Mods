Mod ZethPack Russian Translation Version 1.7.1.
...
Скачайте файл `ZethPack_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\ZethPack\Assets\Translations\Russian`.
