Mod Candles Lanterns and Beeswax Russian Translation Version 1.1.0.
...
Скачайте файл `CandlesLanternsandBeeswax_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\CandlesLanternsandBeeswax\Assets\Translations\Russian`.
