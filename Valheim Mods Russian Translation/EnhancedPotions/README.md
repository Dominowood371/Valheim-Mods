Mod EnhancedPotions Russian Translation Version 0.3.16.

### Описание

Перевод мода [EnhancedPotions](https://valheim.thunderstore.io/package/hbocao/EnhancedPotions/) на русский язык для игры Valheim. 

### Установка

Скачайте файл `DefaultEnhancedPotions.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\EnhancedPotions`.
