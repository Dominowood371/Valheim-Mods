...
Скачайте файл `SurtlingCoreOverclocking_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\SurtlingCoreOverclocking\Assets\Translations\Russian`.
