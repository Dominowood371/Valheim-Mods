...
### Установка BuildIt Rus.rar

Скачайте архив `BuildIt-1.3.1-Rus.rar` и распакуйте архив, в архиве будет папка `BuildIt` переместите эту папку со всем содержимым в папку с игрой `Valheim\BepInEx\plugins`.
...
### Скачивание BuildIt Rus.rar
1. Найдите архив `BoneAppetit-1.3.1-Rus.rar`, который вы хотите загрузить.
2. Нажмите на его, чтобы просмотреть содержимое файла в GitHub.
...
[![Скачать](https://img.shields.io/badge/Скачать-1.3.1-blue?style=for-the-badge)]()
