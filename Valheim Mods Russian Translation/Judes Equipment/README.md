Mod JotunnBackpacks Russian Translation Version 1.0.0 - 1.1.0.

### Описание

Перевод мода [JotunnBackpacks](https://valheim.thunderstore.io/package/GoldenJude/Judes_Equipment/) на русский язык для игры Valheim. 

### Установка

Скачайте файл `JudesEquipment_russian.json` и с заменой переместите файл в папку `Valheim\BepInEx\plugins\JudesEquipment\Assets\Translations\Russian`.
